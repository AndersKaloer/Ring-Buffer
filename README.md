...
The size of the memory buffer must be a power-of-two, and the buffer can contain at most `buf_size-1` bytes.
...
```
In this case, the buffer size is 64 bytes and can contain 63 bytes.
